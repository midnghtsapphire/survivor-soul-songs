"""Configuration for Survivor Soul Songs."""
from pydantic_settings import BaseSettings
from functools import lru_cache

class Settings(BaseSettings):
    APP_NAME: str = "Survivor Soul Songs"
    APP_URL: str = "http://localhost:8003"
    DATABASE_URL: str = "postgresql://appuser:password@db:5432/survivorsoul"
